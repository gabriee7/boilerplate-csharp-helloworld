...
{
    public abstract class MyTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyTestDbContext, Task<T>> func)
        {
            T result;
